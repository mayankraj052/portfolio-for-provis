      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center mb-16">
          ...
          <h2 className="text-4xl md:text-5xl font-bold text-white mb-4">
            About <span className="bg-gradient-to-r from-violet-400 to-indigo-400 bg-clip-text text-transparent">Me</span>
          </h2>
        </div>
        ...
        <div className="space-y-12">
          ...
          <div className="flex flex-col items-center gap-8">
            <div className="relative group w-64 sm:w-80">
              {/* Gradient Border */}
              <div className="absolute -inset-1 bg-gradient-to-r from-violet-600 via-fuchsia-600 to-indigo-600 rounded-2xl blur-lg opacity-75 group-hover:opacity-100 transition duration-500"></div>
            ...
            <div className="text-center max-w-3xl space-y-4">
              <p className="text-slate-300 text-2xl leading-relaxed">
                I'm a passionate <span className="text-violet-400 font-semibold">Computer Science Engineering</span> student with a strong interest in 
                ...
                <span className="text-indigo-400 font-semibold">TypeScript</span>, and Deep Learning frameworks.
              </p>
              <p className="text-slate-300 text-xl leading-relaxed">
                Currently, I am honing my skills in <span className="text-violet-400 font-semibold">Cloud Computing</span>,{" "}
                <span className="text-fuchsia-400 font-semibold">Rust</span>, and{" "}
                <span className="text-indigo-400 font-semibold">DevOps</span>, while also exploring 
          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-6">
            {highlights.map((item, index) => {
              ...
              return (
                <div
                  key={index}
                  className="group relative overflow-hidden bg-slate-800/50 backdrop-blur-sm border border-slate-700/50 rounded-xl p-6 hover:border-slate-600 transition-all duration-300 text-center"
                >
          ...
          <div className="grid sm:grid-cols-2 gap-6">
            <div className="flex items-center gap-3 bg-slate-800/50 backdrop-blur-sm border border-slate-700/50 rounded-xl p-4 group hover:border-violet-500/50 transition-all duration-300">
            ...
            <div className="flex items-center gap-3 bg-slate-800/50 backdrop-blur-sm border border-slate-700/50 rounded-xl p-4 group hover:border-indigo-500/50 transition-all duration-300">
